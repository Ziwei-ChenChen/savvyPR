---
title: "savvyPR: Savvy Parity Regression (PR) Model Estimation"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteEncoding{UTF-8}
  %\VignetteIndexEntry{savvyPR: Savvy Parity Regression (PR) Model Estimation}
...
```{r, error=TRUE, fig.width=7, fig.height=5}
options(width = 80)
